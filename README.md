...
``` bash
git clone https://github.com/justweb1/streamers-toolbox.git
```
...
Voila! You can use your Streamers Toolbox app in a local development environment with hot reload !
